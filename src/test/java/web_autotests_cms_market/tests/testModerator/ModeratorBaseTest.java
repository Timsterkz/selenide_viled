package web_autotests_cms_market.tests.testModerator;
...
public class ModeratorBaseTest extends TestBase {

    @BeforeAll
    public static void moderatorBase() {
        step("открыть вкладку модератор", ModeratorBaseStep::moderator);
    }
